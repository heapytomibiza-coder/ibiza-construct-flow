...
import { plumbingQuestionPacks } from '../_shared/plumbingPacks.ts';
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    console.log(`🔧 Seeding ${plumbingQuestionPacks.length} Plumbing emergency question packs...`);
    ...
    for (const pack of plumbingQuestionPacks) {
      try {
    ...
    return new Response(
      JSON.stringify({
        message: 'Plumbing emergency question packs seeded',
        results,
      }),
      {
