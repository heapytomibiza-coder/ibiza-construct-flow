...
Deno.serve(async (req) => {
  ...
  try {
    ...
    console.log(`🏪 Seeding ${commercialOfficeQuestionPacks.length} Commercial, Office, Retail, Kitchen/Bathroom, Storage, Extensions, Brickwork, Pool Heating, Pool Construction, Pool Equipment, Pool Maintenance, Spa & Water Treatment question packs...`);
    ...
    return new Response(
      JSON.stringify({
        message: 'Commercial, Office, Retail, Kitchen/Bathroom, Storage, Extensions, Brickwork, Pool Heating, Pool Construction, Pool Equipment, Pool Maintenance, Spa & Water Treatment question packs seeded',
        results,
      }),
      {
