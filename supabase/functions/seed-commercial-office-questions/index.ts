...
Deno.serve(async (req) => {
  ...
  try {
    ...
    console.log(`🏪 Seeding ${commercialOfficeQuestionPacks.length} Commercial, Office, Retail, Kitchen/Bathroom, Storage, Extensions, Brickwork, Pool, Spa, Water Treatment, Painting/Decorating Exterior, Interior & Specialist, Floors/Doors/Windows (Internal Doors, Windows) question packs...`);
    ...
    return new Response(
      JSON.stringify({
        message: 'Commercial, Office, Retail, Kitchen/Bathroom, Storage, Extensions, Brickwork, Pool, Spa, Water Treatment, Painting/Decorating Exterior, Interior & Specialist, Floors/Doors/Windows (Internal Doors, Windows) question packs seeded',
        results,
      }),
      {
