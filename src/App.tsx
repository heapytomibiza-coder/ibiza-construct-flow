...
const ProfessionalServicesWizardPage = lazyWithRetry(() => import("./pages/ProfessionalServicesWizardPage"));
                ...
                <Suspense fallback={<RouteFallback />}>
                  <Routes>
                    ...
                    <Route path="/admin" element={
                      ...
                      <Route path="question-pack-standardizer" element={<QuestionPackStandardizer />} />
                      ...
                      <Route path="question-pack-generator" element={<QuestionPackGenerator />} />
