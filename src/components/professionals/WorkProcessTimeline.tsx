              ...
              return (
                <div key={index} className="relative flex gap-4 group">
                  ...
                  <div className="flex-1 pb-8">
                    <div className={`bg-gradient-to-br from-background to-muted/30 p-4 rounded-lg border-2 border-transparent group-hover:border-primary/20 transition-all duration-300 ${!isLast ? 'mb-4' : ''}`}>
