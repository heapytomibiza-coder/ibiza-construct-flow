        ...
        <div className="border-t border-white/20 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex flex-wrap gap-6">
              ...
              <Link to="/cookie-policy" className="text-body text-white/60 hover:text-copper text-sm transition-all duration-300">{(t('legal.links', { returnObjects: true }) as string[])[2]}</Link>
            </div>
          </div>
        </div>
      </div>
