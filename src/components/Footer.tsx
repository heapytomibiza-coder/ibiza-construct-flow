        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-6">
              ...
              <div>
                <h3 className="text-display font-semibold text-white text-lg">CS Ibiza</h3>
                <p className="text-xs text-white/70 -mt-1">Elite Network</p>
              </div>
            </div>
            <p className="text-body text-white/80 mb-6 leading-relaxed">
              Constructive Solutions Ibiza connects you with the island's most trusted construction professionals. From quick fixes to luxury builds.
            </p>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-body text-white/80">Ibiza, Balearic Islands, Spain</span>
              </div>
              <div className="flex items-center space-x-3">
                <Phone className="w-5 h-5 text-copper flex-shrink-0" />
                <span className="text-body text-white/80">+34 971 XXX XXX</span>
              </div>
              <div className="flex items-center space-x-3">
                <Mail className="w-5 h-5 text-copper flex-shrink-0" />
                <span className="text-body text-white/80">hello@csibiza.com</span>
              </div>
            </div>

            <div className="mt-6">
              <h5 className="text-display font-medium text-white mb-3">Emergency Service</h5>
              <p className="text-body text-white/80 text-sm">24/7 support for urgent repairs</p>
              <p className="text-copper font-semibold">+34 600 XXX XXX</p>
            </div>
          </div>
        </div>
