  ...
  return (
    <div className="space-y-4 sm:space-y-6 relative px-4 sm:px-0">
      ...
      <div className="space-y-3">
        <div className="flex items-center gap-2 mb-3 sm:mb-4">
          <span className="text-lg sm:text-xl">💼</span>
          <h3 className="text-base sm:text-lg font-bold">Business Tools</h3>
        </div>
      ...
      <div className="space-y-3">
        <div className="flex items-center gap-2 mb-3 sm:mb-4">
          <span className="text-lg sm:text-xl">🤝</span>
          <h3 className="text-base sm:text-lg font-bold">Client Management</h3>
        </div>
      ...
      <Collapsible open={isSettingsOpen} onOpenChange={setIsSettingsOpen}>
        <motion.div
          initial={false}
          className="relative overflow-hidden rounded-xl sm:rounded-2xl bg-gradient-to-br from-sage/8 via-sage/4 to-transparent backdrop-blur-lg border border-sage/20"
        >
          <CollapsibleTrigger asChild>
            <Button
              variant="ghost"
              className="w-full flex items-center justify-between p-3 sm:p-4 hover:bg-sage/5 active:bg-sage/10 transition-colors min-h-[44px]"
            >
              <div className="flex items-center gap-2">
                <Settings className="h-4 w-4 text-sage-dark" />
                <span className="font-semibold text-xs sm:text-sm">Settings & Tools</span>
              </div>
              <motion.div
          ...
          <CollapsibleContent className="px-2 sm:px-4 pb-2 sm:pb-4">
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ duration: 0.2 }}
      ...
      <motion.div
        ...
        className="relative overflow-hidden rounded-xl sm:rounded-2xl bg-gradient-to-br from-sage/15 via-sage/8 to-transparent backdrop-blur-xl border border-sage/30 p-6 sm:p-8 shadow-[0_20px_60px_0_rgba(0,0,0,0.1)]"
      >
        {/* Animated background glow */}
        <motion.div
          className="absolute top-0 right-0 w-64 sm:w-96 h-64 sm:h-96 bg-sage/10 rounded-full blur-3xl"
          animate={{
            scale: [1, 1.2, 1],
            opacity: [0.3, 0.5, 0.3],
          }}
        ...
        <div className="relative z-10 text-center space-y-3 sm:space-y-4">
          ...
          >
            <Button
              size="lg"
              className="bg-sage hover:bg-sage-dark text-white shadow-[0_8px_24px_rgba(var(--sage),0.3)] hover:shadow-[0_12px_32px_rgba(var(--sage),0.4)] transition-all duration-300 min-h-[44px]"
